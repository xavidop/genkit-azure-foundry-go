...
If this change affects Azure Foundry functionality:

- [ ] Tested with multiple Foundry models
- [ ] Verified Azure credential handling
- [ ] Checked error handling for Azure API calls
