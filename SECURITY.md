...
We take the security of our software seriously. If you believe you have found a security vulnerability in the Azure Foundry Plugin for Genkit Go, please report it to us as described below.
...
- **Never hardcode Azure credentials** in your code
- Use managed identities when running in Azure environments
- Use Azure credential profiles or environment variables for local development
- Regularly rotate your Azure access keys
- Follow the principle of least privilege for Azure role-based access control (RBAC) permissions
...
- The core plugin code (`azureaifoundry_plugin.go`)
...
- Issues that require access to Azure credentials (credential theft is out of scope)
